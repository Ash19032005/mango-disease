...
# # Your Hugging Face repository name (e.g., "your-username/your-repo-name")
# HF_REPO_ID = "Iamashwin1903/mango-disease"

# # A dictionary to hold your models' filenames on Hugging Face.
# MODELS = {
#     "model1": "resnet.h5",
#     "model2": "vgg-16.h5",
...
# # A simple cache to store loaded model objects
# model_cache = {}

# def load_model_from_hf(model_filename):
#     """
#     Downloads and loads a model from Hugging Face, with caching.
#     """
#     if model_filename in model_cache:
#         return model_cache[model_filename]

#     try:
#         # Download the model file from Hugging Face's hub.
#         # This will save the file to a local cache.
#         model_path = hf_hub_download(
#             repo_id=HF_REPO_ID,
#             filename=model_filename
#         )
        
#         # Load the TensorFlow model from the downloaded path
...
#         raise HTTPException(status_code=500, detail=f"Failed to load model {model_filename} from Hugging Face.")

# # This function remains the same, but is now called with a dynamic target_size.
...
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["https://mango-disease-ui.onrender.com"],
#     allow_credentials=False,  # Set to False unless credentials are needed
